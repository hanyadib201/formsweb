...
export class QuizService {
   ...
   private apiUrl = 'https://formsapi.garassolutions.com/api/Quizzes/QuizId';
 // private apiUrl = 'https://hanyadib606.bsite.net/api/Quizzes/QuizId';
  ...
  submitUserAnswers(data: UserAnswer) {
    ...
    return this.http.post('https://formsapi.garassolutions.com/api/UserAnswers', data);
  }
  getQuestionsWithAnswers(quizId: number) {
    return this.http.get(`https://formsapi.garassolutions.com/api/UserAnswers?QuizId=${quizId}`);
  }
}
